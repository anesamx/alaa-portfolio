...
const Hero = () => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center min-h-screen text-center text-white bg-cover bg-center hero-bg px-4"
    >
      <h1 className="text-6xl sm:text-8xl font-story-script">Alaa's Portfolio</h1>
      <p className="mt-4 text-lg sm:text-xl font-lato">i draw art with mous why u DONT TRY </p>

      <div className="flex flex-col sm:flex-row items-center justify-center mt-8 sm:space-x-6 space-y-6 sm:space-y-0">
        <a
        ...
        <div className="flex space-x-4">
          <a href="https://www.instagram.com/alaa.1b/" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-3xl sm:text-4xl hover:text-purple-400 transition duration-300" />
          </a>
          <a href="https://www.tiktok.com/@alaa.1b?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer">
            <FaTiktok className="text-3xl sm:text-4xl hover:text-purple-400 transition duration-300" />
          </a>
          <a href="https://t.me/alaa_draw" target="_blank" rel="noopener noreferrer">
            <FaTelegram className="text-3xl sm:text-4xl hover:text-purple-400 transition duration-300" />
          </a>
        </div>
      </div>
